...
class DoubanMusic_split(torch.utils.data.Dataset):
...
class DoubanMusic_sparse_split(torch.utils.data.Dataset):
...
class DoubanBook_split(torch.utils.data.Dataset):
...
class DoubanMovie_split(torch.utils.data.Dataset):
